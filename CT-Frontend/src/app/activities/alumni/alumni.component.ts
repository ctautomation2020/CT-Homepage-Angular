...
export class AlumniComponent implements OnInit {
    ...
    constructor(private activatedRoute:ActivatedRoute, private alumniService:AlumniService, private titleService:Title) {
    ...
    validateAlumni(){
        ...
        if(this.reg_no != "" && this.dob != ""){
            this.alumniService.checkAlumni({reg_no:this.reg_no, dob:this.dob}).subscribe(data => {
                let result:any = data;
                if(result.length){
                    ...
                    else this.error_message = "Only Passed-out stduents can register!";
                }
    ...
    registerAlumni(){
        ...
        if(this.work != "" && this.role != ""){
            this.alumniService.registerAlumni({reg_no:this.reg_no, work:this.work, role:this.role}).subscribe(data => {
                if(data && !data.status){
                    this.success =  true;
