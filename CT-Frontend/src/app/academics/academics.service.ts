...
export class AcademicsService {
        ...
        ug:[
            {
                ...
                description:"This regulation is for the students admitted to the B.E. Programme at the University Departments from the Academic year 2018 - 2019 onwards.",
                link:"assets/files/academics/ug/rusa2018/rusa2018.pdf"
            },
            {
                regu_type:"cbcs2015",
                title:"2015 Regulation - CBCS",
                description:"This regulation is for the students admitted to the B.E. Programme at the University Departments from the Academic year 2015 - 2016 onwards.",
                link:"assets/files/academics/ug/cbcs2015/cbcs2015.pdf"
            },
            {
                regu_type:"cbcs2013",
                title:"2013 Regulation - CBCS",
                description:"Lorem ipsum dolor, sit amet consectetur adipisicing elit. Nihil consectetur ratione doloremque architecto nobis corporis voluptates neque hic odio quo! Deleniti, doloribus. Alias, nesciunt repellat!",
                link:"assets/files/academics/ug/cbcs2013/cbcs2013.pdf"
            }
        ],
        pg:[
            {
                ...
                description:"This regulations is for the students admitted to M.E. / M.Tech. (Full-Time, Part Time), M.C.A., M.Sc. (Full Time) (2 Years) Programmes at various University Departments from the Academic year 2019-2020 onwards.",
        ...
        phd:[
            {
                ...
                description:"Lorem ipsum dolor, sit amet consectetur adipisicing elit. Nihil consectetur ratione doloremque architecto nobis corporis voluptates neque hic odio quo!",
            ...
            'rusa2018':{
                ...
                'sem3': {
                    ...
                    subjects: [
                        ...
                        {
                            code: 'CS6105',
                            title: 'Digital Fundamentals and Computer Organization',
                            credits: { L: 3, T: 1, P: 4, C: 7 }
                        },
                        {
                            code: 'MA6351',
                ...
                'pe':{
                    ...
                    'track6': [
                        ...
                        {
                            title: "Queuing Theory and Performance Evaluation of Computer Systems",
                            code: "CS6028",
                            credits: { L: 3, T: 0, P: 0, EL: 3, C: 4 }
                        },
                        {
            ...
            '2019':{
                'sem1':{
                    subjects:[
                        {
                            code: 'MA5153',
                            title: 'Advanced Mathematics for Scientific Computing',
    ...
    getSemesters(acadType:string, type:string, count:number){
        ...
        if(this.subjects[acadType][type]){
            for(let extra of extras){
                if(this.subjects[acadType][type][extra]) sems.push({ code:extra, title:extra.toUpperCase() });
            }
        }
    ...
    getSubjects(acadType:string, sem:string, regu:string){
        return (this.subjects[acadType][regu]) ? this.subjects[acadType][regu][sem].subjects : [];
    }
    ...
    getPath(acadType:string, regu:string, sem:string){
        return "assets/files/academics/"+ acadType +"/" + regu + "/" + sem + "/";
    }
    getSupervisorList(){
