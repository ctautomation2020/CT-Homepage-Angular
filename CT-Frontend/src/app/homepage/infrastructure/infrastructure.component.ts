...
@Component({
    selector: 'home-page-infrastructure',
        ...
        let labs = {
            academic: [
                ...
                },
                {
                    ...
                    lab_image:
                        'assets/img/infrastructure/distributed_comuting.jpg',
                    processor: 'Intel Core i7',
                    hard_disk: '1TB',
                    ram: '8GB',
                    nodes: 75,
                ...
                },
                {
                    ...
                    lab_image:
                        'assets/img/infrastructure/pervasive_computing.jpg',
                ...
                },
                {
                    ...
                    nodes: 57,
                    description:
                        'The Multi-core lab provides an elegant environment with multi-core systems for the undergraduate students to carry out their research projects. Applications in various domains like blockchain, networking, and artificial intelligence are carried out. The lab is equipped with GPUs that supports video analytics and machine learning projects that demand intense computational power. The high-end compilers provide a flexible environment to execute programs written in any high-level language.',
                },
                {
            ...
            research: [
                {
                    ...
                    lab_image:
                        'assets/img/infrastructure/next_gener_networks.png',
                    processor: 'Intel Core i7',
                    hard_disk: '2TB',
                    ram: '16GB',
                    nodes: 7,
            ...
            servers: [
                ...
                },
                {
                    ...
                    server_image:
                        'assets/img/infrastructure/fujitsu_server_preview.png',
            ...
            storages: [
                {
                    ...
                    server_image:
                        'assets/img/infrastructure/fujitsu_storage.jpg',
                ...
                },
                {
                    ...
                    server_image:
                        'assets/img/infrastructure/server_preview.jpg',
                    processor: 'Intel Xeon Silver 4110',
                    hard_disk: '2TB',
                    number: '4',
                    type: 'SAN',
